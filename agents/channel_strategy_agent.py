...
def main():
    ...
    print(f"[channel_strategy_agent] Starting for '{niche}' ({date_str})")
    ...
    generate_args = ["--niche", niche, "--output", STRATEGY_PATH]
    ...
    subject = f"[YT Automation] Channel Strategy Ready — {niche} ({date_str})"
